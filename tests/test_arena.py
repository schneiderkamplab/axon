...
from brainsurgery.engine.arena import ProviderError, SegmentedFileBackedArena, ensure_supported_dtype, prod
...
def test_arena_allocate_rejects_invalid_sizes(tmp_path) -> None:
    arena = SegmentedFileBackedArena(tmp_path, segment_size_bytes=32, alignment=8)
